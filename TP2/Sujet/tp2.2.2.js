...
console.log(albumTitle(albums["Fresh Cream"]));//Recup le nom de l'artiste
console.log(albumArtist(albums["Fresh Cream"]));//Recup le nom de l'artiste
console.log(albumYear(albums["Fresh Cream"]));//Recup le nom de l'artiste